<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="/rm/admin/index.php">Roy Medical Admin</a>
    <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    <a class="nav-link" href="/rm/admin/index.php">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/rm/admin/manage-users">Users</a>
                            <a class="nav-link" href="/rm/admin/manage-products">Products</a>
                            <a class="nav-link" href="/rm/admin/manage-orders">Orders</a>
                            <a class="nav-link" href="/rm/admin/manage-appointments">Appointments</a>
                        </nav>
                    </div>
                </div>
            </div>
