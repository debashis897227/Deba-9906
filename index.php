      ...
      <form action="forms/appointment.php" method="post">
        ...
        <div class="row">
          <div class="col-md-4 form-group mt-3">
            <?php
            $doctor_sql = 'SELECT doctors.id AS doctor_id, users.id AS user_id, users.name , doctors.availability, doctors.visit_fee
               FROM doctors 
          ...
          <div class="col-md-4 form-group mt-3">
            <input type="text" class="form-control datepicker" disabled id="show_fee">
          </div>
          <div class="col-md-4 form-group mt-3">
          ...
          <input type="hidden" name="visit_fee" id="visit_fee">

          <div class="col-md-4 form-group mt-3">
            <input type="datetime-local" name="date" class="form-control datepicker" id="date" placeholder="Appointment Date" required="">
          </div>
          <div class="col-md-4 form-group mt-3">
            <input type="time" name="time" class="form-control" id="time" placeholder="Appointment time" required="">
          </div>
          <!-- <div class="col-md-4 form-group mt-3">
        ...
        <div class="mt-3">
          ...
          <div class="text-center"><button type="submit" style="background-color: #1977cc; border-radius:50px; padding: 6px 15px; margin: 0 15px 0 0; color: white;" >Make an Appointment</button></div>
        </div>
      </form>
      ...
      if (doctorId !== "") {
        $.ajax({
          ...
          success: function(response) {
            ...
            let availableDays = response.availableDays;
            let openingTime = response.openingTime;
            let closingTime = response.closingTime;
            let visit_fee = response.visit_fee;
            $("#show_fee").val(visit_fee)
            $("#visit_fee").val(visit_fee)
            $("#time").on("change", function() {
              let timeInput = $(this);
              let selectedTime = timeInput.val();

              let minTime = openingTime; // Set dynamically if needed
              let maxTime = closingTime;

              if (selectedTime < minTime || selectedTime > maxTime) {
                alert("Please select a time between " + openingTime + " To " + closingTime);
                timeInput.val(""); // Reset the field
              }
            });
            $("visit_fee").val(visit_fee);
            ...
            $("#time").attr("min", openingTime);
            $("#time").attr("max", closingTime);
